...
INSERT INTO `usuario` VALUES (1,'jose','Jose Manuel','asf','administrador','activo',234,'$2y$10$iJJll0jreD/sxU2XW1/Ipu5Op2Hfs0m9Pc.wZC4zkAwXTPBXh5TxG','as');
...
/*!50001 VIEW `entregas_segun_las_areas_de_salud` AS select `promotor_realiza_actividad_grupal_con_personas_receptoras`.`region_de_salud` AS `region_de_salud`,sum(`promotor_realiza_actividad_grupal_con_personas_receptoras`.`condones_entregados`) AS `total_condones`,sum(`promotor_realiza_actividad_grupal_con_personas_receptoras`.`lubricantes_entregados`) AS `total_lubricantes` from `promotor_realiza_actividad_grupal_con_personas_receptoras` group by `promotor_realiza_actividad_grupal_con_personas_receptoras`.`region_de_salud` */;
...
-- Dump completed on 2019-08-07 11:46:53
