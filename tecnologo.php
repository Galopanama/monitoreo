...
class Tecnologo_Realiza_Prueba{
    ...
    public function getId_cedula_persona_receptora ($id_cedula_persona_receptora){
        return $this->id_cedula_persona_receptora = $id_cedula_persona_receptora;
    }
    ...
    public function getConsejeria_pre_prueba ($consejeria_pre_prueba){
        return $this->consejeria_pre_prueba = $consejeria_pre_prueba;
    }
    ...
    public function getConsejeria_post_prueba ($consejeria_post_prueba){
        return $this->consejeria_post_prueba = $consejeria_post_prueba;
    }
    ...
    public function getResultado_prueba ($resultado_prueba) {
        return $this->resultado_prueba = $resultado_prueba;
    }

    public function setRealizacion_prueba ($realizacion_prueba) {
        $this->realizacion_prueba = $ealizacion_prueba;
    }  

    public function getRealizacion_prueba ($realizacion_prueba) {
        return $this->realizacion_prueba = $realizacion_prueba;
    }
}
