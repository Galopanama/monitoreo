...
class Individuales extends Entrevista{
...
$uso_del_condon,$uso_de_alcohol_y_drogas_ilicitas, $informacion_clam,$referencia_a_pruebas_de_vih,$referencia_a_clinica_tb){
