...
// Llamada al objeto de la base de datos
...
if (!empty($_POST['id_cedula_persona_receptora_buscada_1'])) {
    ...
    for ($i = 1; $i <= $numero_filas_mostrar; $i++) {
        // Paramos de contar cuando la cedula esté vacía
    ...
    if (empty($errores)) {
        ...
        // Creamos la instancia de persona y añadimso la informacion 
        for ($i = 1; $i <= $numero_filas_enviadas; $i++){
            ...
            try { 
            ...
            } // Si no se encuentra, se manda un peticion para crearla
                ...
                // Devuelve otros errores encontrados
                catch (Exception $e) {
