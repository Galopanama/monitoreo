    ...
    if (empty($errores)) {
        ...
        try {
            ...
            $datos_persona_receptora = [
                ...
                'poblacion' => $_POST['poblacion'],                                     // ESTE CAMPO Y EL SIGUIENTE SON DE OTRA TABLA
                'poblacion_originaria' => $_POST['poblacion_originaria']?true:false     //PERO SE PODRIAN VER EN ESTA TABLA SI ES QUE EL USUARIO EXISTE??
            ];
...
// $smarty->assign('tipos_poblacion_permitidos', PersonasReceptoras::tipos_poblacion_permitidos); DUDA POR SI SE PUEDE O NO INTRODUCIR EN EL FORMULARIO
