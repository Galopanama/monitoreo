<?php
/**
 * Este fichero creará nuevos usuarios.
 * El Administrador introducirá la informacion de los nuevos usuarios y esta será enviada a la 
 * base de datos
 */
...
// la informacion de los usarios se carga desde este fichero
...
if (!empty($_POST['login'])) {
    ...
    if (empty($errores)) {
        ...
        try {
            Usuarios::add($datos);      
            // Si todos los datos del formulario son correctos, la peticion es enviada utilizando el metodo add de la Clase Usuarios
        }
            ...
            // Cualquier otro error se recogen en la variable $e
        }
